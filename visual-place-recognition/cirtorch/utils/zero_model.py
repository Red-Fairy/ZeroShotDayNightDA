...
class enhance_net_nopool_m2(nn.Module):

	def __init__(self,scale_factor,curve_round=8,down_scale=0.95, encode_dim=1):
		super(enhance_net_nopool_m2, self).__init__()
		...
		self.param_est = nn.Sequential(
			nn.Conv2d(number_f, number_f, kernel_size=3, stride=2, padding=1),
	...
	def forward(self, x, exp):
		...
		down_scale = self.param_est(x4).view(b,1,1,1)
...
class enhance_net_nopool_m3(nn.Module):

	def __init__(self,scale_factor,curve_round=8, down_scale=0.95, encode_dim=1):
		super(enhance_net_nopool_m3, self).__init__()
...
class enhance_net_nopool_m4(nn.Module):

	def __init__(self,scale_factor,curve_round=8, down_scale=0.95, encode_dim=1):
		super(enhance_net_nopool_m4, self).__init__()
