...
def flow_vgg16(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        pretrained_model = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'pretrained/vgg16-397923af.pth')
...
if __name__ == '__main__':
    ...
    # ---------
    net = flow_vgg16(pretrained=True, num_classes=11)
    data = torch.randn(1,20,224,224)
    output = net(data)
    print(output.shape)
