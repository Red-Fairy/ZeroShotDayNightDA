...
try:
    ...
    import initializer
    from utils import load_state
    from utils import SimpleSpatialTemporalModule, ClsHea


__all__ = ['InceptionV1_I3D']

# @BACKBONES.register_module
class InceptionV1_I3D_FLOW(nn.Module):
    ...
    def __init__(self,
                 ...
                 modality='Flow',
                 num_classes=11):
        super(InceptionV1_I3D_FLOW, self).__init__()
    ...
    #                 constant_init(m, 1)
        ...
        if pretrained:
            pretrained_model=os.path.join(os.path.dirname(os.path.realpath(__file__)), 'pretrained/i3d_kinetics_flow_inception_v1.pth')
...
if __name__ == '__main__':
    ...
    # ---------
    net = InceptionV1_I3D_FLOW(pretrained=True)
    data = torch.randn(1,2,16,224,224)
    output = net(data)
    print(output.shape)