...
parser.add_argument('--task-name', type=str, default='action',
...
if __name__ == '__main__':
	...
	log_dir = os.path.join(args.model_dir, f'test')
	...
	if args.dataset.upper() == 'MINIKINETICS':
		...
		video_location = os.path.join(data_root, 'raw', 'SMOID')
		# video_location = os.path.join(data_root, 'raw', 'StableLLVE')
