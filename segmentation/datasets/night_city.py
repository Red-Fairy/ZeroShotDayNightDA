...
class NightCityDataset(Cityscapes):
    ...
    def __init__(self, root, split='val', transforms=None, add=''):
        ...
        self.imgs_root = os.path.join(root, f'NightCity-images/images/{split}')
        self.masks_root = os.path.join(root, f'NightCity-label/label/{split}')
